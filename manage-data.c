...
void get_array (int Arrlen, int Totalrows, MPI_Comm comm, int mpi_rank, float *Arr, char dataset[], char infile[]) {
...
void get_array1 (int Arrlen, int Totalrows, MPI_Comm comm, int mpi_rank, float *Arr, char dataset[], char infile[]) {
